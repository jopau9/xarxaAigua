/**
 * @file controladorCicles.java
 * @brief Classe ControladorCicles que controla la finestra cicles.fxml i gestiona la cerca de cicles per a una aixeta.
...
public class controladorCicles {
     ...
     * @brief Gestiona l'acció de buscar cicles per a una aixeta
     * @pre L'usuari ha seleccionat una aixeta de la caixa de selecció
     * @post Si s'ha seleccionat una aixeta, es tanca la finestra i s'inicia la cerca de cicles per a l'aixeta seleccionada
     */
    @FXML
    void buscarCicles(ActionEvent event) {
        ...
        controladorPrincipal.teCicles(a);
    }

    /**
     * @param event Event d'acció
     * @brief Cancel·la l'operació de cerca de cicles
     * @pre Cert
